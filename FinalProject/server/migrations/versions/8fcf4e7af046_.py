...
Revision ID: 8fcf4e7af046
Revises: 
Create Date: 2018-02-25 21:43:41.324299
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('listing_type_id')
    )
    ...
    op.create_table('listing_identifier',
    sa.Column('listing_id', sa.Integer(), nullable=True),
    sa.Column('listing_type_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['listing_id'], ['listing.listing_id'], ),
    sa.ForeignKeyConstraint(['listing_type_id'], ['listing_type.listing_type_id'], )
    )
...
def downgrade():
    ...
    op.drop_table('listing_identifier')
